...
* `name` - (Optional) The name of the auto scaling group. By default generated by Terraform. Must be less than or equal to 255 characters in length.
* `name_prefix` - (Optional) Creates a unique name beginning with the specified
  prefix. Conflicts with `name`. Must be less than or equal to 229 characters in length.
...
* `version` - (Optional) Template version. Can be version number, `$Latest`, or `$Default`. (Default: `$Default`). Must be between 1 and 255 characters in length.
